...
public class GUIMainController {
    ...
    public ListView listViewAnimation;
    @FXML
...
//        initBot ();
        ...
        vBoxAddTitlePanet.setOnMouseClicked (new EventHandler<MouseEvent> () {
            @Override
            public void handle(MouseEvent mouseEvent) {
                if (mouseEvent.getClickCount () == 2){
                    ServiceImport serviceImport = new ServiceImport (vBoxAddTitlePanet, vBoxEditServiceTitlePanet);
                    serviceImport.readServicePrice (false);
                    serviceImport.updateVbox ();
                }
            }
        });
...
//        new MyListView (listViewAnimation, vBoxAddTitlePanet);
//
//        MyListView.addButton (10);
...
//    Метод поиска клиента
    ...
    public void listViewOpacity(ActionEvent actionEvent) {
        new Thread (()->{

            for(double d = 0; d < 1.00; d+=0.000001) {
                listViewAnimation.setOpacity (d);
    ...
    public void addNewServise(ActionEvent actionEvent) {

        new StageNewService (vBoxEditServiceTitlePanet);
    }
}
