...
public class ClientStage {
    ...
    public ClientStage (Node node, ClientClass client) {

        this.client = client;
        client.getRegTelegramInfo();
        Stage mainStage = (Stage) node.getScene ().getWindow ();
        Stage clientStage = new Stage();
        clientStage.setTitle("Данные по клиенту");
        vBoxMain = new VBox();
        ...
        TextField telephoneText = new TextField(client.getTelephone());
        ...
        TextField birthDayText = new TextField(client.getDateBirth());
        ...
        TextArea infoText = new TextArea(client.getInfoClient());
        ...
        TextField emailText = new TextField(client.getEmail());
        ...
        CheckBox checkBoxTrainer = new CheckBox("Тренер");
        checkBoxTrainer.setSelected(client.checkTrainer());
        checkBoxTrainer.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle (ActionEvent event) {
                if (checkBoxTrainer.isSelected()){
                    if (!client.checkTrainer()) {
                        new Trainer(client, 0).addDataBase();
        ...
        vBox.getChildren().addAll(firstNameLab, firstNameText, lastNameLab, lastNameText, patronymicNameLab, patronymicNameText,
                                      telephoneLab, telephoneText, birthDayLab, birthDayText,  infoLab, infoText, hBoxEmail, emailText , hBoxTelegram, checkBoxTrainer, buttonSave, buttonDelete);
