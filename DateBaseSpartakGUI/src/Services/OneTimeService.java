...
public class OneTimeService extends Service {
    ...
    public OneTimeService (int type, int numberGroup, String name, double cost, int balance, boolean timeControl, double addSumTimeControl) {
        this.Type = type;
    ...
    public OneTimeService (int id, int type, int numberGroup, String name, double cost, int balance, boolean timeControl, double addSumTimeControl) {
        this.Type = type;
        this.numberGroup = numberGroup;
        this.id = id;
        this.name = name;
