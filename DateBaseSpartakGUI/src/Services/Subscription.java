...
public class Subscription extends Service{
    ...
    public Subscription (int type, int numberGroup, String name, double cost, int balance, int numberVisits,int numberClient, int termDays, boolean timeControl, double addSumTimeControl) {
        this.Type = type;
    ...
    public Subscription (int id, int type, int numberGroup, String name, double cost, int balance, int numberVisits, int numberClient, int termDays, boolean timeControl, double addSumTimeControl) {
        this.Type = type;
        this.numberGroup = numberGroup;
        this.id = id;
        this.name = name;
    ...
    public boolean addToDataBase(){
        ...
        try {
            ...
            String query = "INSERT INTO ServicePrice ( " +
                           "ID_TYPE, ID_GROUP, NAME, COST, DELETE_CHECK, BALANCE, NUMBER_VISITS, NUMBER_CLIENTS, TERM_DAYS, timeControl, addSumTimeControl " +
                           ") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
...
//                    ") VALUES (?, ?, ?, ?, ?, ?);";
            ...
            statement.setInt(9, this.getTermDays());
            statement.setBoolean(10, this.isTimeControl ());
            statement.setDouble(11, this.getAddSumTimeControl ());
//
